...
url = "https://api.jcdecaux.com/vls/v1/stations?contract=Goteborg&apiKey=9fcde589b2071fa7895969c4f0a186f2beb6ac84"
...
with codecs.open("/home/aholab/javier/tfg/tools/parsers/data/Goteborg.txt", "a", "utf8") as file:
    file.write(totalQuery)
#
## Upload local backup to Dropbox
#os.system("./dropbox_uploader.sh upload TFG/tools/parsers/data/Goteborg.txt /TFG/")
